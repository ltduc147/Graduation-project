...
HD_PWD='D:/Graduation_Project/NIDS_ARTYZ7/NIDS_ARTYZ7.runs/design_1_processing_system7_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_processing_system7_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_processing_system7_0_4.tcl
